...
var FX = {};
  ...
  function buttonEffect() {
    ...
    for (var i = 0; i < 800; i = i + 1) {
      ...
      //alert("creating particle");
      createParticle({
        x: x,
        y: y,
        degree: degree,
        speed: Math.randMinMax(350, 150),
  ...
  function createParticle(args) {
    ...
    var options = {
      x: width / 2,
      y: height / 2,
      color: 'hsla(' + Math.randMinMax(0, 400) + ', 100%, 50%, ' + (Math.random().toFixed(2)) + ')',
      degree: Math.randMinMax(0, 360),
      speed: Math.randMinMax(300, 350),
      vd: Math.randMinMax(-90, 90),
      vs: Math.randMinMax(-5, -5)
    };
